...
class TriageLog(models.Model):
    ...
    sintomas_reportados = EncryptedTextField()
    nivel_alerta = models.CharField(max_length=20)
    respuesta_ia = EncryptedTextField()
    resumen_medico = EncryptedTextField()
...
class RegistroInteraccionBot(models.Model):
    ...
    mensaje_paciente = EncryptedTextField(help_text="Mensaje exacto enviado por el paciente")
    respuesta_bot = EncryptedTextField(help_text="Respuesta generada por el asistente de IA")
