"""
Django settings for samr_project project.
...
WSGI_APPLICATION = 'samr_project.wsgi.application'
ASGI_APPLICATION = 'samr_project.asgi.application'
...
# Optimización de compresión de estáticos
